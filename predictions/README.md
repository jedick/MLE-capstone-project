...
- Files in `ckpt_rationale` directory were created with ../model/script/ckpt_rationale.sh.
- See [the notebook](../doc/08_Checkpoints_and_Rationale_Weight.ipynb) for more information.

## Baseline models

- Files in `baseline` directory [[cf59c5](https://github.com/jedick/RefSup/commit/cf59c51ab8d022070d65716bda1cbe4d704c9a51)].
